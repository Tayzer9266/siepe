...
##### Run Stored Proc to Map Inactive Instruments to WatchListMap table
$SqlQuery = 'EXEC dbo.pInactiveInstrumentsLoad'
fExecuteSQL $ServerName $Core $SqlQuery $LogFile