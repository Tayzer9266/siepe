...
###***** Set the GenericNormalizationView variables *****
$GenericNormalizationViewSQLQuery = "SELECT DISTINCT REFRefDataSourceID,ReferenceRefDataSetType,ReferenceLabel from Feeds.dbo.vNormalizationView WHERE RefRecStatusID = 1 AND GenericNormalizationJobID = $GenericNormalizationJobID"
$GenericNormalizationViewData = fExecuteSQL -pServerName $ServerName -pDatabaseName $Feeds -pQuery $GenericNormalizationViewSQLQuery
$Ref_RefDataSourceID = $GenericNormalizationViewData.REFRefDataSourceID
$RefDataSetType = $GenericNormalizationViewData.ReferenceRefDataSetType
$RefLabel = $GenericNormalizationViewData.ReferenceLabel
